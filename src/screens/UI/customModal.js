...
import { View, StyleSheet, Modal,Image, Button, TextInput,Text} from "react-native";
        ...
        <View style={styles.centerContainer}>
          ...
          <Ionicons name="close" size={23} onPress={props.closeHandler}></Ionicons>
            ...
            <View style={{flexDirection:'row'}}>
              <Button title={!image?'Pick an image':'Select another?'} onPress={pickImage} />
              <View>
              {image && <Image source={{ uri: image }} style={{ width: 80, height: 80 }}  />}
              </View>
            </View>
            <View style={{color:'black'}}>
              <TextInput placeholder="Enter your Name" style={styles.nameInput} onChangeText={(modifiedText)=>setDishName(modifiedText)} />
            </View>
